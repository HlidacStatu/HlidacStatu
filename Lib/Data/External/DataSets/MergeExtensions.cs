...
namespace HlidacStatu.Lib.Data.External.DataSets
{
    ...
    public static class MergeExtensions
    {
        ...
        public static JToken Merge(
            this JToken left, JToken right, JsonMergeSettings options)
        {
        ...
        {
            return Merge(left, right, new JsonMergeSettings());
        }
        ...
        public static void MergeInto(
            this JContainer left, JToken right, JsonMergeSettings options)
        {
            foreach (var rightChild in right.Children<JProperty>())
            {
                ...
                else
                {
                    ...
                    {
                        switch (options.MergeArrayHandling)
                        {
