 ...
 */
        ...
        public void UpdateVazbyFromDB()
        {
            ...
            var firstRel = Graph.VsechnyDcerineVazby(this.ICO);
            ...
            lock (lockInfoObj)
            {
                if (_infofacts == null)
                {
                    ...
                    else
                    {
                        ...
                        long numFatalIssue = HlidacStatu.Lib.ES.SearchTools.SimpleSearch($"ico:{this.ICO} AND chyby:zasadni", 0, 0, HlidacStatu.Lib.ES.SearchTools.OrderResult.FastestForScroll).Total;
                        long numVazneIssue = HlidacStatu.Lib.ES.SearchTools.SimpleSearch($"ico:{this.ICO} AND chyby:vazne", 0, 0, HlidacStatu.Lib.ES.SearchTools.OrderResult.FastestForScroll).Total;
