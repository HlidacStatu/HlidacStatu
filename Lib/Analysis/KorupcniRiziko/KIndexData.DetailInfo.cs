                ...
                switch (part)
                {
                    case KIndexParts.PercentBezCeny:
                        switch (lbl)
                        {
                            ...
                            case KIndexLabelValues.E:
                                return $"Skrývá ceny u {HlidacStatu.Util.PluralForm.Get((int)this.AnnualData.Statistika.PocetSmluvBezCeny, "{0} smlouvy;{0} smluv;{0} smluv")}.";
                            case KIndexLabelValues.F:
                                return $"Skrývá ceny u varujícího počtu {HlidacStatu.Util.PluralForm.Get((int)this.AnnualData.Statistika.PocetSmluvBezCeny, "{0} smlouvy;{0} smluv;{0} smluv")} z {this.AnnualData.Statistika.PocetSmluv} smluv.";
                            default:
                                return "";
                        }
                    case KIndexParts.PercSeZasadnimNedostatkem:
                        switch (lbl)
                        {
                            ...
                            case KIndexLabelValues.B:
                            case KIndexLabelValues.C:
                                return $"Zásadní nedostatky u {HlidacStatu.Util.PluralForm.Get((int)this.AnnualData.Statistika.PocetSmluvSeZasadnimNedostatkem, "{0} smlouvy;{0} smluv;{0} smluv")}.";
                            case KIndexLabelValues.D:
                            case KIndexLabelValues.E:
                            case KIndexLabelValues.F:
                                return $"Zásadní nedostatky u <b>{HlidacStatu.Util.PluralForm.Get((int)this.AnnualData.Statistika.PocetSmluvSeZasadnimNedostatkem, "{0} smlouvy;{0} smluv;{0} smluv")}</b> z {this.AnnualData.Statistika.PocetSmluv} smluv.";
                            default:
                                return "";
                        }
                    case KIndexParts.CelkovaKoncentraceDodavatelu:
                        switch (lbl)
                        {
                            ...
                            case KIndexLabelValues.F:
                                return $"Většinu peněz {HlidacStatu.Util.PluralForm.Get(this.AnnualData.CelkovaKoncentraceDodavatelu.TopDodavatele().Count(), "dostal {0} dodavatel;dostali {0} dodavatelé;dostalo {0} dodavatelů")} z {this.AnnualData.CelkovaKoncentraceDodavatelu.Dodavatele.Count()}.";
                            default:
                                return "";
                        }
                    case KIndexParts.KoncentraceDodavateluBezUvedeneCeny:
                        switch (lbl)
                        {
                            ...
                            case KIndexLabelValues.D:
                            case KIndexLabelValues.E:
                                return $"Zakázky se skrytou cenou se koncentrují u {HlidacStatu.Util.PluralForm.Get(this.AnnualData.KoncentraceDodavateluBezUvedeneCeny.TopDodavatele().Count(), "{0} dodavatele;{0} dodavatelů;{0} dodavatelů")}.";
                            case KIndexLabelValues.F:
                                return $"Většinu zakázek se skrytou cenou {HlidacStatu.Util.PluralForm.Get(this.AnnualData.KoncentraceDodavateluBezUvedeneCeny.TopDodavatele().Count(), "dostal {0} dodavatel;dostali {0} dodavatelé;dostalo {0} dodavatelů")}.";
                            default:
                                return "";
                        }
                    ...
                    case KIndexParts.PercSmluvUlimitu:
                        switch (lbl)
                        {
                            ...
                            case KIndexLabelValues.E:
                            case KIndexLabelValues.F:
                                return $"{HlidacStatu.Util.PluralForm.Get((int)this.AnnualData.Statistika.PocetSmluvULimitu, "{0} smlouva má;{0} smlouvy mají;{0} smluv má")} hodnotu blízkou limitům veřejných zakázek, což může naznačovat snahu se vyhnout řádné veřejné soutěži.";
                    ...
                    case KIndexParts.PercNovaFirmaDodavatel:
                        switch (lbl)
                        {
                            ...
                            case KIndexLabelValues.E:
                            case KIndexLabelValues.F:
                                return $"Uzavřeli {HlidacStatu.Util.PluralForm.Get((int)this.AnnualData.Statistika.PocetSmluvNovaFirma, "{0} smlouvu;{0} smlouvy;{0} smluv")} s nově založenými firmami.";
                            default:
                                return "";
                        }
                    case KIndexParts.PercUzavrenoOVikendu:
                        switch (lbl)
                        {
                            ...
                            case KIndexLabelValues.E:
                            case KIndexLabelValues.F:
                                return $"Uzavřeli {HlidacStatu.Util.PluralForm.Get((int)this.AnnualData.Statistika.PocetSmluvOVikendu, "{0} smlouvu;{0} smlouvy;{0} smluv")} o víkendu nebo svátku.";
                            default:
                                return "";
                        }
                    case KIndexParts.PercSmlouvySPolitickyAngazovanouFirmou:
                        switch (lbl)
                        {
                            ...
                            case KIndexLabelValues.E:
                            case KIndexLabelValues.F:
                                return $"Uzavřeli {HlidacStatu.Util.PluralForm.Get((int)this.AnnualData.Statistika.PocetSmluvPolitiky, "{0} smlouvu;{0} smlouvy;{0} smluv")} s firmami, jejichž majitelé či ony samy sponzorovali politické strany.";
                            default:
                                return "";
                        }
