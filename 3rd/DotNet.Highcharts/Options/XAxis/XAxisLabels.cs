...
namespace DotNet.Highcharts.Options.XAxis
{
	...
	{
        /// <summary>
        /// What part of the string the given position is anchored to.  Can be one of <code>'left'</code>, <code>'center'</code> or <code>'right'</code>. In inverted charts, x axis label alignment and y axis alignment are swapped.<para />
        /// Default: center
        /// </summary>
        ...
        /// <summary>
        /// Polar charts only. The label's pixel distance from the perimeter of the plot area.<para />
        /// Default: 35
        /// </summary>
        public Number? Distance { get; set; }

        /// <summary>
        /// Enable or disable the axis labels.<para />
        /// Default: true
        /// </summary>
        ...
        /// <summary>
        /// The pixel padding for axis labels, to ensure white space between them.<para />
        /// Default: 5
        /// </summary>
