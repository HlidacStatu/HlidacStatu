...
{ 
    ...
    { 
        ...
        /// <summary>
        /// Gets or Sets Smlouvy
        /// </summary>
        [Required]
        [DataMember(Name="smlouvy")]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  Smlouvy: ").Append(Smlouvy).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(InlineResponse200 other)
        {
            ...
            return 
                ...
                (
                    Smlouvy == other.Smlouvy ||
                    Smlouvy != null &&
                    Smlouvy.SequenceEqual(other.Smlouvy)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (Smlouvy != null)
                    hashCode = hashCode * 59 + Smlouvy.GetHashCode();
                return hashCode;
            }
        }
