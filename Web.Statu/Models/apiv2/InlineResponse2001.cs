...
{ 
    ...
    { 
        /// <summary>
        /// Celkový počet dokumentů v databázi, které odpovídají vyhledávacímu parametru
        /// </summary>
        /// <value>Celkový počet dokumentů v databázi, které odpovídají vyhledávacímu parametru</value>
        [Required]
        [DataMember(Name="celkem")]
        public int? Celkem { get; set; }

        /// <summary>
        /// Gets or Sets Zakazky
        /// </summary>
        [Required]
        [DataMember(Name="zakazky")]
        public List<VerejnaZakazka> Zakazky { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  Zakazky: ").Append(Zakazky).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(InlineResponse2001 other)
        {
            ...
            return 
                ...
                (
                    Zakazky == other.Zakazky ||
                    Zakazky != null &&
                    Zakazky.SequenceEqual(other.Zakazky)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (Zakazky != null)
                    hashCode = hashCode * 59 + Zakazky.GetHashCode();
                return hashCode;
            }
        }
