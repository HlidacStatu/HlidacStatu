...
namespace HlidacStatu.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [AllowAnonymous]
        public async Task<ActionResult> ConfirmEmail(string userId, string code, string nextUrl)
        {
        ...
        public async Task<ActionResult> ExternalLoginCallback(string returnUrl)
        {
            ...
            switch (result)
            {
                ...
                default:
                    ...
                    //code from ExternalLoginConfirmation
        ...
        public ActionResult LogOff()
        {
            ...
            return RedirectToAction("Index", "Home", new { rnd = Guid.NewGuid().ToString("N") });
